...
| 4–6 Tests and builds | 112 pytest tests, 8 frontend tests; `make check` includes Ruff, Oxlint, mypy, TypeScript, Python wheel/sdist and Vite build. Latest results recorded in the PR. |
...
| 16 CI | Existing Ubuntu full suite plus native Windows/macOS runtime tests. Inspect all PR checks before handoff; no artifact/release publication added. |
